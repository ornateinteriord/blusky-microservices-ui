    ...
    },
    {
      ...
      renderCell: (row: CashTx) => (
        <Typography variant="body2" sx={{ fontWeight: 600, color: row.withdrawal > 0 ? '#dc2626' : '#6b7280' }}>
          {row.withdrawal > 0 ? `$ ${row.withdrawal.toFixed(4)}` : '-'}
        </Typography>
      ),
    },
    {
      ...
      renderCell: (row: CashTx) => (
        <Typography variant="body2" sx={{ fontWeight: 600, color: row.deposits > 0 ? '#10b981' : '#6b7280' }}>
          {row.deposits > 0 ? `$ ${row.deposits.toFixed(4)}` : '-'}
        </Typography>
      ),
    },
    {
      ...
      <Box sx={{
        ...
        >
          ...
          <Typography variant="h5" sx={{ fontWeight: 700, fontSize: { xs: '1.25rem', sm: '1.5rem' } }}>
            $ {cashTransactionsData?.summary?.openingBalance?.toFixed(4) || '0.00'}
          </Typography>
        </Paper>
        ...
        >
          ...
          <Typography variant="h5" sx={{ fontWeight: 700, fontSize: { xs: '1.25rem', sm: '1.5rem' } }}>
            $ {cashTransactionsData?.summary?.debitAmount?.toFixed(4) || '0.00'}
          </Typography>
        </Paper>
        ...
        >
          ...
          <Typography variant="h5" sx={{ fontWeight: 700 }}>
            $ {cashTransactionsData?.summary?.creditAmount?.toFixed(4) || '0.00'}
          </Typography>
        </Paper>
        ...
        >
          ...
          <Typography variant="h5" sx={{ fontWeight: 700 }}>
            $ {cashTransactionsData?.summary?.closingBalance?.toFixed(4) || '0.00'}
          </Typography>
        </Paper>
      </Box>
