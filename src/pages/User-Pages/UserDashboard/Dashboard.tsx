  ...
  return (
    <Box sx={{
      ...
      <Paper elevation={0} sx={{
        ...
        {/* <Typography variant="h6" sx={{ color: '#ffffff', fontWeight: 900, mb: 3, textAlign: 'center', letterSpacing: '1px' }}>
          WALLET BALANCES
        </Typography> */}
        <Box sx={{ 
          display: 'flex', 
          ...
          <Box onClick={() => navigate('/user/upgrade-wallet')} sx={{ display: 'flex', flexDirection: 'column', p: { xs: 2, sm: 3 }, borderRadius: '20px', bgcolor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', transition: 'transform 0.2s', '&:hover': { transform: 'scale(1.02)', bgcolor: 'rgba(255,255,255,0.05)' }, cursor: 'pointer' }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', mb: 2 }}>
              ...
              <Typography sx={{ color: '#ffffff', fontWeight: 900, fontSize: { xs: '1.3rem', sm: '1.6rem' }, letterSpacing: '1px', m: 0 }}>${Number(walletOverview?.upgradeWalletBalance || 0).toLocaleString('en-US', { minimumFractionDigits: 4, maximumFractionDigits: 4 })}</Typography>
            </Box>
            <Box sx={{ width: '100%' }}>
          ...
          <Box onClick={() => navigate('/user/wallet')} sx={{ display: 'flex', flexDirection: 'column', p: { xs: 2, sm: 3 }, borderRadius: '20px', bgcolor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', transition: 'transform 0.2s', '&:hover': { transform: 'scale(1.02)', bgcolor: 'rgba(255,255,255,0.05)' }, cursor: 'pointer' }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', mb: 2 }}>
              ...
              <Typography sx={{ color: '#ffffff', fontWeight: 900, fontSize: { xs: '1.3rem', sm: '1.6rem' }, letterSpacing: '1px', m: 0 }}>${Number(walletOverview?.balance || 0).toLocaleString('en-US', { minimumFractionDigits: 4, maximumFractionDigits: 4 })}</Typography>
            </Box>
            <Box sx={{ width: '100%' }}>
            ...
            <Paper elevation={0} sx={{ p: 4, borderRadius: '32px', bgcolor: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 10px 40px rgba(0,0,0,0.15)', mt: 1 }}>
              <Stack spacing={4}>
                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: '1fr', gap: 2 }}>
                  ...
                  <Box onClick={() => navigate('/user/earnings/referral-bonus')} sx={{ display: 'flex', flexDirection: 'column', cursor: 'pointer', p: 3, borderRadius: '24px', bgcolor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', transition: 'transform 0.2s', '&:hover': { transform: 'scale(1.02)', bgcolor: 'rgba(255,255,255,0.05)' } }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', mb: 2 }}>
                      <Box sx={{ p: 1.5, borderRadius: '16px', bgcolor: 'rgba(245, 158, 11, 0.1)', display: 'flex', height: 'fit-content' }}>
                        <PaymentsIcon sx={{ fontSize: 32, color: '#f59e0b' }} />
                      </Box>
                      <Typography variant="h5" sx={{ color: '#ffffff', fontWeight: 900, m: 0 }}>${Number(walletOverview?.directBenefits || 0).toLocaleString('en-US', { minimumFractionDigits: 4, maximumFractionDigits: 4 })}</Typography>
                    </Box>
                    <Box sx={{ width: '100%' }}>
                      <Typography variant="subtitle1" sx={{ color: 'rgba(255,255,255,0.9)', fontWeight: 800, mb: 0.5 }}>Referral Income</Typography>
                      <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)', display: 'block', lineHeight: 1.3, width: '100%', fontSize: '13px' }}>Turn every referral into a rewarding opportunity with instant bonus earnings.</Typography>
                    </Box>
                  </Box>

                  <Box onClick={() => navigate('/user/earnings/level-benefits')} sx={{ display: 'flex', flexDirection: 'column', cursor: 'pointer', p: 3, borderRadius: '24px', bgcolor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', transition: 'transform 0.2s', '&:hover': { transform: 'scale(1.02)', bgcolor: 'rgba(255,255,255,0.05)' } }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', mb: 2 }}>
                      <Box sx={{ p: 1.5, borderRadius: '16px', bgcolor: 'rgba(255, 215, 0, 0.1)', display: 'flex', height: 'fit-content' }}>
                        <AccountTreeIcon sx={{ fontSize: 32, color: '#FFD700' }} />
                      </Box>
                      <Typography variant="h5" sx={{ color: '#ffffff', fontWeight: 900, m: 0 }}>${Number(walletOverview?.levelBenefits || 0).toLocaleString('en-US', { minimumFractionDigits: 4, maximumFractionDigits: 4 })}</Typography>
                    </Box>
                    <Box sx={{ width: '100%' }}>
                      <Typography variant="subtitle1" sx={{ color: 'rgba(255,255,255,0.9)', fontWeight: 800, mb: 0.5 }}>Level Income</Typography>
                      <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)', display: 'block', lineHeight: 1.3, width: '100%', fontSize: '13px' }}>Every new level brings greater rewards—keep progressing and keep earning</Typography>
                    </Box>
                  </Box>

                  <Box onClick={() => navigate('/user/earnings/single-level-income-history')} sx={{ display: 'flex', flexDirection: 'column', cursor: 'pointer', p: 3, borderRadius: '24px', bgcolor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', transition: 'transform 0.2s', '&:hover': { transform: 'scale(1.02)', bgcolor: 'rgba(255,255,255,0.05)' } }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', mb: 2 }}>
                      <Box sx={{ p: 1.5, borderRadius: '16px', bgcolor: 'rgba(239, 68, 68, 0.1)', display: 'flex', height: 'fit-content' }}>
                        <TrendingUpIcon sx={{ fontSize: 32, color: '#ef4444' }} />
                      </Box>
                      <Typography variant="h5" sx={{ color: '#ffffff', fontWeight: 900, m: 0 }}>${Number(walletOverview?.singleLineIncome || 0).toLocaleString('en-US', { minimumFractionDigits: 4, maximumFractionDigits: 4 })}</Typography>
                    </Box>
                    <Box sx={{ width: '100%' }}>
                      <Typography variant="subtitle1" sx={{ color: 'rgba(255,255,255,0.9)', fontWeight: 800, mb: 0.5 }}>Single Level Income</Typography>
                      <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)', display: 'block', lineHeight: 1.3, width: '100%', fontSize: '13px' }}>One growing network, multiple earning opportunities—powered by your single-leg structure.</Typography>
                    </Box>
                  </Box>

                  <Box onClick={() => navigate('/user/earnings/global-income-history')} sx={{ display: 'flex', flexDirection: 'column', cursor: 'pointer', p: 3, borderRadius: '24px', bgcolor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', transition: 'transform 0.2s', '&:hover': { transform: 'scale(1.02)', bgcolor: 'rgba(255,255,255,0.05)' } }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', mb: 2 }}>
                      <Box sx={{ p: 1.5, borderRadius: '16px', bgcolor: 'rgba(59, 130, 246, 0.1)', display: 'flex', height: 'fit-content' }}>
                        <PublicIcon sx={{ fontSize: 32, color: '#3b82f6' }} />
                      </Box>
                      <Typography variant="h5" sx={{ color: '#ffffff', fontWeight: 900, m: 0 }}>${Number(walletOverview?.globalIncome || 0).toLocaleString('en-US', { minimumFractionDigits: 4, maximumFractionDigits: 4 })}</Typography>
                    </Box>
                    <Box sx={{ width: '100%' }}>
                      <Typography variant="subtitle1" sx={{ color: 'rgba(255,255,255,0.9)', fontWeight: 800, mb: 0.5 }}>Global Income</Typography>
                      <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)', display: 'block', lineHeight: 1.3, width: '100%', fontSize: '13px' }}>Earn from your global network as your community continues to grow</Typography>
                    </Box>
                  </Box>

                  <Box onClick={() => navigate('/user/transactions?type=Withdrawal')} sx={{ display: 'flex', flexDirection: 'column', cursor: 'pointer', p: 3, borderRadius: '24px', bgcolor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', transition: 'transform 0.2s', '&:hover': { transform: 'scale(1.02)', bgcolor: 'rgba(255,255,255,0.05)' } }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', mb: 2 }}>
                      <Box sx={{ p: 1.5, borderRadius: '16px', bgcolor: 'rgba(168, 85, 247, 0.1)', display: 'flex', height: 'fit-content' }}>
                        <AttachMoneyIcon sx={{ fontSize: 32, color: '#a855f7' }} />
                      </Box>
                      <Typography variant="h5" sx={{ color: '#ffffff', fontWeight: 900, m: 0 }}>${Number(walletOverview?.totalWithdrawal || 0).toLocaleString('en-US', { minimumFractionDigits: 4, maximumFractionDigits: 4 })}</Typography>
                    </Box>
                    <Box sx={{ width: '100%' }}>
                      <Typography variant="subtitle1" sx={{ color: 'rgba(255,255,255,0.9)', fontWeight: 800, mb: 0.5 }}>Total Withdrawal</Typography>
                      <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)', display: 'block', lineHeight: 1.3, width: '100%', fontSize: '13px' }}>Your total withdrawals, displayed for quick and easy financial tracking</Typography>
                    </Box>
                  </Box>
