...
import { DASHBOARD_CUTSOM_STYLE, getTopUpWalletColumns,  } from '../../../utils/DataTableColumnsProvider';
    ...
    >
      <CardContent sx={{ padding: isMobile ? "12px" : "24px" }}>
        <Grid container spacing={3} sx={{ mb: 3 }}>
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              >
                ${Number(walletData?.topUpBalance || 0).toFixed(2)}
              </Typography>
            </Box>
          </Grid>
        </Grid>
        ...
        <div style={{ marginBottom: "1rem", color: "#000", fontWeight: "bold", fontSize: "1.25rem"     }}>Transaction History</div>
          {walletData?.topUpTransactions && walletData.topUpTransactions.length > 0 ? (
              <DataTable
                columns={getTopUpWalletColumns()}
                data={walletData.topUpTransactions}
                pagination
