            ...
            <Box sx={{ flex: 1, display: 'flex', overflow: 'hidden', minHeight: 0 }}>
                ...
                <Box sx={{ flex: 1, display: { xs: !showChatWindow && !selectedRoomId ? 'none' : 'flex', lg: 'flex' } }}>
                    {selectedRoomId ? (
                        ...
                        <Box sx={{ display: { xs: 'none', lg: 'flex' }, flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', bgcolor: '#F8FAFC', flex: 1 }}>
                            ...
                            <Typography variant="h5" fontWeight={600} gutterBottom sx={{ color: '#0F172A' }}>Select a conversation</Typography>
                            <Typography variant="body2" sx={{ color: '#475569', maxWidth: 400, textAlign: 'center' }}>Choose a conversation from the list to start chatting</Typography>
                        </Box>
                    )}
                </Box>
            </Box>
